...
// Clase de ejemplo para el patrón de Singleton
class RegistroActividad {
public:
    RegistroActividad() : m_numActs(0) {}

    static RegistroActividad* getInstance() { // Obtiene la instancia del Singleton
    ...
    void addActivity(const string actividad) { // Función para agregar una actividad al registro
    ...
    void showActivities() { // Función para mostrar todas las actividades registradas
